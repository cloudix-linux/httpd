...
Patch29: httpd-2.2.23-rotatelogs.patch
Patch30: httpd-2.2.3-r982629.patch
Patch32: httpd-2.2.3-ldaprefer.patch
Patch33: httpd-2.2.24-ssluserid.patch
# Bug fixes
...
Patch72: httpd-2.2.21-expectnoka.patch
Patch74: httpd-2.2.15-aboverflow.patch
Patch75: httpd-2.2.21-pr45444.patch
Patch76: httpd-2.2.15-ssldupkeys.patch
Patch80: httpd-2.2.15-oomabort.patch

# this is an amazon modified version of httpd-2.2.15-sslsninotreq.patch
Patch84: httpd-2.2.27-sslsninotreq.patch
...
for f in ssl.conf welcome.conf manual.conf notrace.conf ; do
...
%config(noreplace) %{_sysconfdir}/httpd/conf.d/notrace.conf
...
%exclude %{_mandir}/man8/apxs.8.gz
%{_mandir}/man8/*
...
* Mon Sep 15 2014 hpetty <hpetty@amazon.com>
- update to 2.2.29

* Wed Jul 30 2014 hpetty <hpetty@amazon.com>
- Add patches for CVE-2014-0118, CVE-2014-0226, and CVE-2014-0231

* Mon Apr 21 2014 cyler <cyler@amazon.com>
- Upgrade to httpd-2.2.27

* Mon Dec 9 2013 Cyle Riggs <cyler@amazon.com>
- Upgrade to httpd-2.2.26

* Thu Jul 11 2013 Lee Trager <ltrager@amazon.com>
- Update to 2.2.25 from upstream

* Mon May 13 2013 Cristian Gafton <gafton@amazon.com>
- import source package RHEL6/httpd-2.2.15-28.el6_4

* Tue Apr 30 2013 Andrew Jorgensen <ajorgens@amazon.com>
- Normalize and fix symlinks

* Mon Apr 29 2013 Joe Orton <jorton@redhat.com> - 2.2.15-28
- mod_rewrite: add security fix for CVE-2013-1862 (#953729)

* Fri Mar 22 2013 Cristian Gafton <gafton@amazon.com>
- update to upstream version 2.2.24
...
- import source package RHEL6/httpd-2.2.15-26.el6
...
* Sun Oct 21 2012 Lee Trager <ltrager@amazon.com>
- Update to 2.2.23 from upstream Apache
...
- upgrade to 2.2.22 for latest CVE fixes [2011-3607, 2011-4317, 2012-0053, 2012-0031]
- rebase patchsets to 2.2.21

* Wed Feb 15 2012 Cristian Gafton <gafton@amazon.com>
- fix rpm changelog post merge
- import source package RHEL6/httpd-2.2.15-15.el6_2.1
...
- import source package RHEL6/httpd-2.2.15-15.el6

* Wed Oct 26 2011 Cristian Gafton <gafton@amazon.com>
- import source package RHEL6/httpd-2.2.15-9.el6_1.3

* Thu Oct  6 2011 Joe Orton <jorton@redhat.com> - 2.2.15-9.3
...
* Tue Sep 20 2011 Cristian Gafton <gafton@amazon.com>
...
* Thu Sep  1 2011 Cristian Gafton <gafton@amazon.com> - 2.2.20-1
- update to version 2.2.20
- remove CVE-2011-3192 workaround since 2.2.20 has code fix

* Thu Sep 1 2011 Cristian Gafton <gafton@amazon.com>
- fix changelog typo
- update to 2.2.20
- import source package RHEL6/httpd-2.2.15-9.el6_1.2
...
* Thu Aug 25 2011 Matt Wilson <msw@amazon.com> - 2.2.16-1
- CVE-2011-3192: add a configuration mitigation for range header DoS
  vulnerability

* Thu Aug 25 2011 Matt Wilson <msw@amazon.com>
- add cve workaround file to file list
- add a mitigation for CVE-2011-3192 - Range header DoS vulnerability
...
- import source package RHEL6/httpd-2.2.15-9.el6
...
- import source package RHEL6/httpd-2.2.15-5.el6

* Wed Oct 13 2010 Nathan Blackham <blackham@amazon.com>
- updating to 2.2.16; enabling mod_file_cache moduel building

* Fri Aug 13 2010 Joe Orton <jorton@redhat.com> - 2.2.15-5
- add security fix for CVE-2010-1452 (#618193)

* Sat Jul 31 2010 Cristian Gafton <gafton@amazon.com>
...
- import source package RHEL6/httpd-2.2.15-2.el6
- import source package RHEL6/httpd-2.2.14-5.el6
...
- import source package RHEL5/httpd-2.2.3-43.el5
- import source package RHEL5/httpd-2.2.3-31.el5_4.4
- import source package RHEL5/httpd-2.2.3-31.el5_4.2
- import source package RHEL5/httpd-2.2.3-31.el5
- import source package RHEL5/httpd-2.2.3-22.el5_3.2
- import source package RHEL5/httpd-2.2.3-22.el5_3.1
- import source package RHEL5/httpd-2.2.3-22.el5
- import source package RHEL5/httpd-2.2.3-11.el5_2.4
- import source package RHEL5/httpd-2.2.3-11.el5_1.3
- import source package RHEL5/httpd-2.2.3-11.el5
- import source package RHEL5/httpd-2.2.3-7.el5
- import source package RHEL5/httpd-2.2.3-6.el5
- added submodule prep for package httpd
